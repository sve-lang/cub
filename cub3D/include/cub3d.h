...
/*   Updated: 2020/11/16 15:08:59 by jrosemar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_draw_sprite2(t_info *arg, t_sprite *sprite, int i,
				int j);
...
int					ft_read_file(char *filename, t_info *arg);
...
int					**ft_add_memory(t_mlx *img, int *arr_addr, int k,
					t_info *arg);
void				ft_check_map4(char **map, t_info *arg, int i, int j);
void				ft_init_player(t_player *player, char c, double x,
				double y);
